...
from schemas.investments.investment_log_schema import InvestmentLogBase, InvestmentLogCreate, InvestmentLogUpdate
...
@router.get("/meta/investment-log")
def get_meta():
    return export_schema(InvestmentLogBase)
