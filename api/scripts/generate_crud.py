...
def create():
    ...
    try:
        ...
        return Response.ok_data(result.model_dump(), _("{upper}_CREATED"), 201, name)
...
def get_by_id(id):
    ...
    try:
        ...
        if not result:
            return Response.error(_("{upper}_NOT_FOUND"), _("NONE"), 404, name)

        return Response.ok_data(result.model_dump(), _("{upper}_FOUND"), 200, name)
    except Exception as e:
        return Response.error(_("DATABASE_ERROR"), str(e), 500, name)
...
def update(id):
    ...
    try:
        ...
        return Response.ok_data(result.model_dump(), _("{upper}_UPDATED"), 200, name)
    except Exception as e:
        return Response.error(_("DATABASE_ERROR"), str(e), 500, name)
...
def delete(id):
    ...
    try:
        ...
        return esponse.ok_message(_("{upper}_DELETED"), 204, name)
    except Exception as e:
        return Response.error(_("DATABASE_ERROR"), str(e), 500, name)
'''
