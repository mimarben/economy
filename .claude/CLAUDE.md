Economy App (AI Optimized)

# Test Command

Si el mensaje del usuario es exactamente "test-claude", responde exactamente "leido CLAUDE.md" y nada más.

# Context Files
- ER Diagram: `.claude/database/er.sql`
- ER Diagram: `.claude/database/e-r.png`
